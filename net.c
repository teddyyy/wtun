...
static void
encap_tunnel_udp_header(struct sk_buff* skb,
				int udplen,
				u32 srcip,
				u32 dstip)
{
...
static void
encap_tunnel_ip_header(struct sk_buff* skb,
				int iplen,
				u32 srcip,
				u32 dstip)
{
...
static void
encap_tunnel_eth_header(struct sk_buff* skb,
				u8* srcmac,
				u8* dstmac)
{
...
static u32
find_source_ip(struct rtable* rtbl)
{
...
static int
encap_tunnel_skb(struct sk_buff* skb)
{
...
bool
is_wanted_data(struct sk_buff *skb)
{
...
void
send_by_tunnel(struct sk_buff *skb)
{
	struct sk_buff* newskb = NULL;
	int headroom = sizeof(struct ethhdr)
			+ sizeof(struct iphdr)
